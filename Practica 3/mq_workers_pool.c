 ...
 * el caracter pasado como argumento. Una vez lean el mensaje de finalización
 * enviarán la señal SIGUSR2 al padre. Al recibirla enviará una señal SIGTERM a
 * todos sus hijos los cuales ejecutarán el manejador e imprimiran sus datos
 * por pantalla.
 */
