 ...
 * Consumirá N elementos del almacén que irá guardando en un array, esto lo
 * realizará hasta que consuma el elemento final controlando el acceso al almacén
 * a través de semáforos. Una vez termine imprimirá los elementos leídos y el
 * número de los mismos. A continuación terminará liberando todos los recursos
 * asociados.
 */
